...
<form method="POST">
  ...
  <button id="myButton1" data-toggle="modal" data-target="#modalRegisterForm" class = "btn btn-danger"><i class ="glyphicon glyphicon-warning-sign"></i> Void Transaction </button>
