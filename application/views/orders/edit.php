            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="customer_name" name="customer_name"
                      placeholder="Enter Customer Name" value="<?php echo $order_data['order']['customer_name'] ?>"
                      autocomplete="off" />
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="service_charge" name="service_charge" disabled
                        value="<?php echo $order_data['order']['service_charge'] ?>" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="vat_charge" name="vat_charge" disabled
                        value="<?php echo $order_data['order']['vat_charge'] ?>" autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="Express" name="Express" placeholder="Express"
                      onkeyup="subAmount()" value="<?php echo $order_data['order']['Express'] ?>" autocomplete="off">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="Remarks" name="Remarks" placeholder="Remarks"
                      onkeyup="subAmount()" value="<?php echo $order_data['order']['Remarks'] ?>" autocomplete="off">
                  </div>
                </div>
                <div class="form-group">
                  <label for="Staff" class="col-sm-5 control-label">Staff Name</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="Staff" name="Staff" placeholder="Staff Name"
                      onkeyup="subAmount()" value="<?php echo $order_data['order']['Staff'] ?>" disabled
                      autocomplete="off">
                  </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
  ...
  function subAmount() {
    ...
    if (Express) {
      var grandTotal = Number(totalAmount) + Number(Express);
