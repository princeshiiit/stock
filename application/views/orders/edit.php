              ...
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="Express" name="Express" placeholder="Express" onkeyup="subAmount()" value="<?php echo $order_data['order']['Express'] ?>" autocomplete="off">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="Express" class="col-sm-5 control-label">Remarks</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="Remarks" name="Remarks"  placeholder="Remarks" onkeyup="subAmount()" value="<?php echo $order_data['order']['Remarks'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="Staff" class="col-sm-5 control-label">Staff Name</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="Staff" name="Staff"  placeholder="Staff Name" onkeyup="subAmount()" value="<?php echo $order_data['order']['Staff'] ?>" disabled autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
