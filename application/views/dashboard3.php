...
<div class="content-wrapper">
  ...
  <body>
    ...
    <form method="POST">
      <input type="text" name="Name1" class="form-control" id="exampleFormControlInput1"
        placeholder="Electricity/Water/Others" Required>
      <br />
      <?php
      ...
      <input type="number" min="0" name="Amount1" class="form-control" id="exampleFormControlInput1"
